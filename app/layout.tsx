...
const listingJsonLd = {
  ...
  amenityFeature: [
    ...
    { "@type": "LocationFeatureSpecification", name: "Nest thermostats with zone sensors per floor" },
    { "@type": "LocationFeatureSpecification", name: "Electronic PIN side-door entry" },
